...
<body>
    ...
    <div class="archives-items">
        ...
        foreach ($weapons_array as $obj){
            ...
            if($components_array[$foreach_count]["name"] != "Zhuge Prime"){
                ...
                if ($components_array[$foreach_count]["name"] === $components_array[$foreach_count+1]["name"]) {
                    $foreach_count++; //Increase count every time foreach loop runs even when skipped
                    continue;
                }else{
                    ?>
                    <!-- Display weapons -->
                    <div class="item-container">
                        ...
                        <div class="archives-buttons">
                            <a class="primary-button" href="/primary/{{$weapon}}?type=Primary">Read more</a>
